...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('manage/list_tracksheet_status_change_req'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td>
								<?php 
									$md_approved = $resval->md_approved;

									if($md_approved == 1)
										echo "Approved";
									else if($md_approved == 2)
										echo "Rejected";
									else
										echo "Pending";
								?>								
							...
							<td>	
								<a class="btn btn-primary" href="<?php echo base_url('manage/tracksheet_status_change_req/'. $data_id); ?>">View</a>															
							</td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			

...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('manage/list_questionnaire'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				<?php
					...
					if($result_array)
					{
						...
						{	
							$page_id	=	$resval->page_id;	
				?>							
						<tr>
							<td><?=$SlNo?></td>
							<td><?php echo $page_id; ?></td>
							<td><?php echo $resval->page_title; ?></td>
							<td><?php echo $resval->scheme_name; ?></td>
							<td>
								<?php
									$level	=	$resval->level;
									$level_text = "";
							...
							<td>																		
								<a class="btn btn-primary" href="<?php echo base_url('manage/edit_questionnaire_page/'.$page_id); ?>">Edit</a>
							</td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			

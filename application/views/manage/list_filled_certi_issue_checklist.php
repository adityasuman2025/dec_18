...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('manage/list_filled_certi_issue_checklist'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td>	
								<a class="btn btn-primary" href="<?php echo base_url('manage/view_filled_certi_issue_checklist/'. $data_id. '/' . $level); ?>">View</a>															
							</td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			

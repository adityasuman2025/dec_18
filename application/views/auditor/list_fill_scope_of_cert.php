						...
						<tr>
							...
							<td>
								<?php
									...
									{
										echo "<a class=\"btn btn-primary\" href=\"" . base_url('auditor/view_scope_of_cert/'.$data_id . '/2') . "\">View</a>";
									}
									else
									{
										echo "<a class=\"btn btn-primary\" href=\"" . base_url('auditor/fill_scope_of_cert/'.$data_id . '/2') . "\">Fill</a>";
									}
								?>

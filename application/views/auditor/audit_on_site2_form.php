...
<!------attendence sheet------>
	<div class="col-md-12 col-xs-12 col-sl-12 content">
		...
		<div class="upload_pic_feed">
			<img src="<?php echo base_url('uploads/attendence_sheet/pic_' . $tracksheet_id . "_2.jpg"); ?>" />
		</div>		
	</div>
...
<!-------style and script--------->
		...
		$(document).on('change', '#file', function()
		{
			...
			else
			{
				...
				else
				{
					...
					$.ajax({
						url: "<?php echo base_url('auditor_actions/upload_attendence_sheet/' . $tracksheet_id . '/2'); ?>",
						method: "POST",
						data: form_data,
						contentType: false,
						cache: false,
	...
	//on clicking on update button
		$('.continue_btn').click(function()
		{
			...
			{
				if(data == 1)
					location.href= "<?php echo base_url('auditor/audit_on_site2'); ?>";
				else

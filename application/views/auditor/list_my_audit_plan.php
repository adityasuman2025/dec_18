...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('auditor/list_my_audit_plan1'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('auditor/view_my_audit_plan' . $level . '_form/'. $data_id); ?>">View</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

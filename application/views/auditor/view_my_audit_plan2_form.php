	            ...
	            <div class="box-body">
		            <div class="col-md-6 col-sl-12 col-xs-12">
		                <ul class="nav nav-stacked">
		                	<?php 
								...
								$certification_type_text = "Cert";

								if($certification_type == 1)
								{									
									$certification_type_text = "Cert";
								}
								else if($certification_type == 4)
								{
									$certification_type_text = "RC";
								}
		            ...
		            <div class="col-md-6 col-sl-12 col-xs-12">
		                <ul class="nav nav-stacked">
		                    ...
		                    <li><a href="#">Stage Of Audit<span class="pull-right  ">Stage 2</span></a></li>		
		                    <li>
		                    	<a href="#">Certification Type<span class="pull-right  "><?php echo $certification_type_text; ?></span></a>
		                    </li>		
		              </ul>
		            </div>	
	            </div>   
...
<!--------audit plan team plan------>
	...
	//getting the dates between from date to to date
		$stage1_date_from = $audit_program_form_records['stage2_date_from'];
		$stage1_date_to = $audit_program_form_records['stage2_date_to'];
		$stage1_auditor_sector = $audit_program_form_records['stage2_auditor_sector'];

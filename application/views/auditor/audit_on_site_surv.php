...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('auditor/audit_on_site_surv'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
						...
						<tr>
							...
							<td>
								<?php
									...
									{
								?>
									<a class="btn btn-primary" href="<?php echo base_url('auditor_actions/notify_planning_about_audit_report/' . $data_id . '/' . $level); ?>">Submit</a>
								<?php
									}
									else
									{
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('auditor/audit_on_site_surv_form/'. $data_id . '/' . $level); ?>">Select</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('auditor/list_to_review_audit_reports'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
				...
				?>
						...
						<tr>
							...
							<td>
								<?php
									if($level == 11)
										$href = base_url('auditor/reviewer_view_re_audit_report/'. $data_id . '/' . $cert_level);
									else 
										$href = base_url('auditor/reviewer_view_audit_report/'. $data_id . '/' . $level);
								?>

								<a class="btn btn-primary" href="<?php echo $href; ?>">Select</a>
							</td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			

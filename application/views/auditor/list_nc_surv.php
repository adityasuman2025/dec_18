...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('auditor/list_nc_surv'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('auditor/auditor_view_audit_report_nc/'. $data_id . '/' . $level); ?>">View</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

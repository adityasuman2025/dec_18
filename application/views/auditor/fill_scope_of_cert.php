    ...
    <section class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
	            ...
	            <!-- /.box-header -->
	            <div class="box-body">
		            <form class="col-md-12 col-sl-12 col-xs-12" action="<?php echo base_url('auditor_actions/add_scope_of_cert_in_db'); ?>" method="post">
		            	<input type="hidden" name="tracksheet_id" value="<?php echo $tracksheet_id; ?>">
		            	...
		            	<br>
		            	<textarea class="scope_textarea" name="scope"></textarea>
		            	<br><br>

		            	<b>Lead Auditor Comment</b>
		            	<br>
		            	<textarea class="scope_textarea" name="comment"></textarea>

...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('auditor/list_audit_report_surv_review'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('auditor/auditor_view_audit_report/'.$data_id . '/' . $level); ?>">Select</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

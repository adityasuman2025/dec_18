...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('auditor/audit_on_site_re_cert'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
						...
						<tr>
							...
							<td>
								<?php 
									...
									if($cert_type == 2) //S1
										$level = 3;
									else if($cert_type == 3) //S2
										$level = 4;
									else if($cert_type == 4) //RC
										$level = 2;
							...
							<td>
								<?php
									...
									if($flow_id == 9)
									{
										$redirect_level = 2;
								?>
									<a class="btn btn-primary" href="<?php echo base_url('auditor_actions/notify_planning_about_audit_report/' . $data_id . '/' . $level . '/' . $redirect_level); ?>">Submit</a>
								<?php
									}
									else
									{
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('auditor/audit_on_site_form_re_cert/'. $data_id . '/' . $level); ?>">Select</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('auditor/list_re_audit_on_site_re_cert'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('auditor/re_audit_on_site/'. $data_id . '/' . $level); ?>">Select</a></td>
						</tr>
					<?php	
							$SlNo							=	$SlNo+1;			
						}
...
//on clicking on notify button for stage 1
	$('.notify').click(function()
	{
		...
		var res = $(this).attr('auditor_ids');

		var auditor_ids = res.split("#");

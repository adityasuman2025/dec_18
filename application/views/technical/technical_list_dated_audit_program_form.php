...
?>
<h4 class="text-center">List of tracksheets for which Audit Program is pending</h4>
...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('technical/technical_list_dated_audit_program_form'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
						...
						<tr>
							...
							<td>
								<?php 
									...
									{
								?>
									<a class="btn btn-primary" href="<?php echo base_url('technical/technical_audit_program_form/'.$data_id); ?>">Fill</a>
								<?php		
									}
									else
									{
								?>
									<a class="btn btn-primary" href="<?php echo base_url('technical/technical_view_audit_program_form/'.$data_id); ?>">View</a>
								<?php		
									}
								?>

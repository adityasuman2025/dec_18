...
?>
<h4 class="text-center">List of tracksheets for which application review is pending</h4>
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('technical/application_review_form/'.$data_id); ?>">Fill</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

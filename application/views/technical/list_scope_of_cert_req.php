...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('technical/list_scope_of_cert_req'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td>
								<?php 
									$tech_accepted = $resval->tech_accepted;
									$id = $resval->id;
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('technical/scope_of_cert_req/'. $data_id); ?>">View</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

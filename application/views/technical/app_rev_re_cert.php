...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('technical/application_review'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
					...
					<tr>
						...
						<td>
							<?php
								...
								{
							?>
									<a class="btn btn-primary" href="<?php echo base_url('technical/app_rev_form_re_cert/'. $data_id); ?>">Fill</a>
							<?php
								}
								else
								{
							?>
									<a class="btn btn-primary" href="<?php echo base_url('technical/view_app_rev_form_re_cert/'. $data_id); ?>">View</a>
							<?php
								}
							?>							
						</td>

	...
	<section class="content" >
	    <div class="col-md-12">
	    	<form action="<?php echo base_url("technical_action/update_app_rev_form"); ?>" method="post" name="hello">
	    		...
	    		<input type="hidden" name="scheme_system" value="<?php echo strtolower($database_record->scheme_system); ?>">
	    		<input type="hidden" name="tracksheet_id" id="tracksheet_id" value="<?php echo $database_record->tracksheet_id; ?>">
		        ...
		        <div class="box box-primary">		        	
		            ...
		            <div class="text-center" >	      
		            	...
		            	<br><br><br>
		          		...
		          		<input type="submit" class="btn btn-primary text-center" id="app_review_submit_button" value="Update">
		          		<br><br>
		            </div>
		        </div>

        ...
        <table border="0" cellspacing="0" cellpadding="0" class="table r_tabl">
          <thead>
             <tr>
              ...
              <th><br/>View Certificate</th> 
              <th><br/>Notify Accounts</th> 
            </tr>
          </thead>
           <tbody>
            <?php
              ...
              if($result_array)
              {
                ...
                { 
                  ...
                  $acc_sec_notified = $resval->acc_sec_notified; 
            ?>
            <?php 
            ...
            <tr>
              ...
              <td>
               <a class="btn btn-primary" href="<?php echo base_url('technical/view_certificate/'. $data_id); ?>">View</a>
              </td> 
              <td>
                <?php
                  if($acc_sec_notified !=1)
                  {
                ?>
                  <a class="btn btn-primary" href="<?php echo base_url('technical_action/notify_acc_sec/'. $data_id); ?>">Notify</a>
                <?php
                  }
                  else
                  {

...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('technical/audit_plan_surv'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('technical/audit_plan_surv_form/'.$data_id); ?>">Fill</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

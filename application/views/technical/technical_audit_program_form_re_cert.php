...
//on clicking on submit buttonm
	$('#submit_form_button').click(function()
	{
		...
		//increasing the flow id of that tracksheet
			var flow_id = 8; //audit plan 2 // because for re-certifcation stage-1 audit will not happen
			
			$.post('<?=base_url()?>technical_action/incr_desired_flow_status_of_tracksheet', {tracksheet_id: tracksheet_id, flow_id: flow_id}, function(ok)
			{

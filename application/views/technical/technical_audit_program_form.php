...
<!--------variables-------->
    ...
    if($audit_program_form_records)
    {
		...
		$stage1_auditor_sector = "";
        $stage1_date_from   ="";
		$stage1_date_to = "";

		$stage2_auditor_sector = "";
		$stage2_date_from = "";
		$stage2_date_to = "";

		$surv1_auditor_sector = "";
		$surv1_date_from = "";
		$surv1_date_to = "";

		$surv2_auditor_sector = "";
		$surv2_date_from = "";
		$surv2_date_to = "";
    }
                ...
                <div class="box-body">
                    <div class="col-md-12 col-sl-12 col-xs-12">
                    	<ul class="nav nav-stacked">
                			...
                			<li><a href="#">Date From<span class="pull-right"><?php echo $stage1_date_from; ?></span></a></li>                		
                			<li><a href="#">Date To<span class="pull-right"><?php echo $stage1_date_to; ?></span></a></li>
								...
								<?php
	                    			...
	                    			else
	                    			{
			               			...
			               			foreach ($app_rev_audit_team_record as $key => $value) 
			               			{
			               				...
			               				if($level == 1 && $type== 1 && $sector == $stage1_auditor_sector)
			               				{
			               		?>
			               					<li class="rows_to_update" level="1" row_id="<?php echo $id; ?>"><a>Name<span class="pull-right"><?=$auditor_name ?></span></a></li>
			               		<?php	               				
                ...
                <div class="box-body">
                    <div class="col-md-12 col-sl-12 col-xs-12">
		            	...
		            	<div class="col-md-8 col-sl-8 col-xs-8 ans">
		            		<textarea class="form-control" id="any_add_reso_req"></textarea>
		            	</div>
		            	<br><br><br><br>
                    	...
                    	<!-----listing processes of that scheme system----->	
                    		<?php
                    			foreach ($default_audit_program_process as $key => $value) 
                    			{
                    				$process_name = $value['process_name'];
                    			?>
                    				<li class="audit_prog_proc_list ">
                    					<input class="audit_prog_proc_list_input" id="audit_prog_proc_list_input" type="text" value="<?php echo $process_name; ?>">
                    					 Stage 2
...
//on clicking on submit buttonm
	$('#submit_form_button').click(function()
	{
		...
		var any_add_reso_req = $('#any_add_reso_req').val();
		...
		//increasing the flow id of that tracksheet
			$.post('<?=base_url()?>technical_action/incr_flow_status_of_tracksheet', {tracksheet_id: tracksheet_id}, function(ok)
			{
				$.post("<?php echo base_url('technical_action/fill_any_add_reso_req_in_audit_program'); ?>", {tracksheet_id: tracksheet_id, any_add_reso_req: any_add_reso_req}, function(e)
				{
					if(e ==1)
					{
						location.href = "<?php echo base_url('technical/technical_list_dated_audit_program_form'); ?>";
					}
					else
					{

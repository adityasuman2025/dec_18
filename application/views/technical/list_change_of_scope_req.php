...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('technical/list_change_of_scope_req'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td>
								<?php 
									$technical_accept_scope_change = $resval->technical_accept_scope_change;

									if($technical_accept_scope_change == 1)
									{
										echo "Accepted";
									}
									else if($technical_accept_scope_change == 2)
									{
										echo "Rejected";
									}
									else
							...
							<td><a class="btn btn-primary" href="<?php echo base_url('technical/change_of_scope_req/'.$data_id); ?>">View</a></td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
						}

	        ...
	        <div class="box box-primary">	      
	            ...
	            <!---org address------->
	            	...
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            		<input class="" type="date" id="address_review_date">
	            	</div>
	            ...
	            <!---site addresses------->
		            ...
		            ?>
			            	...
			            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
			            		<input type="date" class="site_review_date" site_id="<?php echo $site_id; ?>">
			            	</div>			          
		            <?php		
		            	}
		            ?>
	            ...
	            <!---scope------->
	            	...
	            	<div class="col-md-8 col-sl-8 col-xs-8 ans">
	            		<input class="form-control" type="text" id="scope" value="<?php echo $database_record->scope; ?>">
	            	</div>
	            ...
	            <!----assesment creteria------>
	            	...
	            	<div class="col-md-6 col-sl-6 col-xs-6 ans">
	            		<input class="form-control" type="text" id="scope_clear">
	            	</div>
	            ...
	            <!----Effective personnel------>
	            	...
	            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
	            		<input class="form-control" type="text" id="total_emp_as_per">
	            	</div>
	            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
	            		<input class="form-control" type="text" id="perma_emp">
	            	</div>
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            		<input class="form-control" type="text" id="part_emp">
	            	</div>
	            	...
	            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
	            		<input class="form-control" type="text" id="contract_lab">
	            		<div class="qstn_qstn"></div>
	            	</div>
	            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
	            		<input class="form-control" type="text" id="temp_skill_un_worker">
	            	</div>
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            		<input class="form-control" type="text" id="total_eff_emp">
	            	</div>
	            ...
	            <!----Justification for Effective personnel: ------>
	            	...
	            	<div class="col-md-7 col-sl-7 col-xs-7 ans">
	            		<input class="form-control" type="text" id="just_for_eff_pers">
	            	</div>
	            	...
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            		<input class="form-control" type="text" id="no_of_sites">
	            	</div>
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            		<input class="form-control" type="text" id="repetitiveness">
	            	</div>
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            		<input class="form-control" type="text" id="complexity_level">
	            	</div>
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            		<input class="form-control" type="text" id="scope_size">
	            	</div>
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            		<input class="form-control" type="text" id="site_remarks">
	            	</div>
	            ...
	            <!------EnMS effective personeel----------->	
	            	...
	            	?>
		            	...
		            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            			<input class="form-control big_ans" type="text" id="enms_eff_perso">
	            		</div>
	            ...
	            <!------accrediation info---------->
	            	...
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
            			<input class="form-control" type="text" id="accr_ava_as_req">
            		</div>
	               	...
	               	<div class="col-md-12 col-sl-12 col-xs-12 center-block">
	               		...
	               		<ul id="anzsic_ul" style="width: 70%; display: block; margin: auto; list-style: none;">
	               			<li>	               				
			                    ...
			                    <a id="anzsic_sugg_link" target="_blank">view details</a>			              			
			                    <br><br>
	               			</li>
	               		</ul>
	            ...
	            <!--------applicant lang--------->
	            	...
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
            			<input class="form-control" type="text" id="applicant_lang">
            		</div>
	            	...
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
            			<input class="form-control" type="text" id="statuary_applicable">
            		</div>
	            	...
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
            			<input class="form-control" type="text" id="safety_req">
            		</div>
	            	...
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
            			<input class="form-control" type="text" id="threat_impart">
            		</div>
            	...
            	<!----------FSMS qstns---------->
	            	...
	            	?>
		            	...
		            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            			<input class="form-control" type="text" id="no_of_pro_line">
	            		</div>
		            	...
		            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            			<input class="form-control" type="text" id="season_of_prod">
	            		</div>
	            	<?php
	            		}
	            	?>
	            	...
	            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
            			<input class="form-control" type="text" id="no_surv_audit_plan">
            		</div>
	            	...
	            	?>
		            	...
		            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            			<input class="form-control" type="text" id="specific_issue">
	            		</div>
	            	<?php
	            		}
	            	?>
	            ...
	            <!------OHSAS qsnts----------->	            	
		            ...
		            <!----dangerous goods-------->
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="dang_good_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="dang_good_expl"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----Vehicle interaction-------->		            
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="veh_intr_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="veh_intr_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----powered plant-------->	
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="powered_plant_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="powered_plant_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----other plant-------->	
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="other_plant_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="other_plant_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----Manual handling-------->		
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="manual_handling_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="manual_handling_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----hazardous substance-------->		            
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="hazardous_subs_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="hazardous_subs_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----atmospheric contaminants-------->		       
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="atmospheric_contam_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="atmospheric_contam_remakrs"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----ionis_rad-------->		
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="ionis_rad_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="ionis_rad_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----confined_space-------->		    
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="confined_space_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="confined_space_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----slips_trips-------->	
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="slips_trips_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="slips_trips_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----noise-------->		   
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="noise_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="noise_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----therm_environ-------->		    
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="therm_environ_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="therm_environ_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----ground_work-------->	
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="ground_work_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="ground_work_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----use_of_explosive-------->		
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="use_of_explosive_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="use_of_explosive_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----elec_hazard-------->		          
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="elec_hazard_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="elec_hazard_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!----press_env-------->		    
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="press_env_score">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12 ans">	            			
	            			<textarea class="form-control" id="press_env_remarks"></textarea>
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            ...
		            <!--------OHS results------->
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control big_ans" type="text" id="total_ohs_score">
		            	</div>	
		            	...
		            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
	            			<input class="form-control" type="text" id="eff_ohs_perso">
	            		</div>		            	
	            	<?php
	            		}
	            	?>
	            ...
	            <!------EMS qsnts----------->
	            	...
	            	?>
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="env_complex_categ">
		            	</div>
		            	<div class="col-md-4 col-sl-4 col-xs-4 qstn">
		            		<div type="text" class="qstn_qstn">Total Sites</div>
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="env_total_sites">
		            	</div>
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="inc_env_complex">
		            	</div>
		            	<div class="col-md-4 col-sl-4 col-xs-4 qstn">
		            		<div type="text" class="qstn_qstn">Sites to be  covered in certification Audit</div>
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="sites_cov_cert_audit_1">
		            	</div>
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="decr_env_complex">
		            	</div>
		            	<div class="col-md-4 col-sl-4 col-xs-4 qstn">
		            		<div type="text" class="qstn_qstn">Sites to be covered in Surveillance  Audit</div>
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="sites_cov_cert_audit_2">
		            	</div>
		            	...
		            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
	            			<input class="form-control" type="text" id="tech_and_regul">
		            	</div>
	            	<?php
	            		}
	            	?>
	            ...
	            <!------EnMS qsnts----------->
	            	...
	            	?>
		            	...
		            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            			<input class="form-control" type="text" id="enms_fec">
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 qstn">
		            		<div type="text" class="qstn_qstn">30%</div>
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="enms_fec_comp_factor">
		            	</div>
		            	...
		            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            			<input class="form-control" type="text" id="enms_fes">
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 qstn">
		            		<div type="text" class="qstn_qstn">30%</div>
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="enms_fes_comp_factor">
		            	</div>
		            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            	...
		            	<div class="col-md-3 col-sl-3 col-xs-3 ans">
	            			<input class="form-control" type="text" id="enms_fseu">
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 qstn">
		            		<div type="text" class="qstn_qstn">40%</div>
		            	</div>
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="enms_fseu_comp_factor">
		            	</div>
	            	<?php
	            		}
	            	?>
	            ...
	            <!------ISMS qsnts----------->
		            ...
		            <!----bussiness and org qstns------>
		            	...
		            	<div class="col-md-4 col-sl-4 col-xs-4 ans">		            		
		            		<input type="text" class="form-control ans" id="type_buss_req" />
		            		<input type="text" class="form-control ans" id="proc_and_tasks" />
		            		<input type="text" class="form-control ans" id="level_of_ms" />
		            	</div>
		            	<div class="col-md-1 col-sl-1 col-xs-1 ans">		            		
		            		<input type="text" class="form-control ans" id="type_buss_req_score" />
		            		<input type="text" class="form-control ans" id="proc_and_tasks_score" />
		            		<input type="text" class="form-control ans" id="level_of_ms_score" />
		            	</div>
		            	<div class="col-md-1 col-sl-1 col-xs-1 ans">		            		
		            		<textarea class="big_big_qstn" id="buss_and_org_score"></textarea>
		            	</div>
		            ...
		            <!----it qstns---------->		
		            	...
		            	<div class="col-md-4 col-sl-4 col-xs-4 ans">		            		
		            		<input type="text" class="form-control ans" id="it_comp" />
		            		<input type="text" class="form-control ans" id="out_supp_service" />
		            		<input type="text" class="form-control ans" id="info_sys_dev" />
		            	</div>
		            	<div class="col-md-1 col-sl-1 col-xs-1 ans">		            		
		            		<input type="text" class="form-control ans" id="it_comp_score" />
		            		<input type="text" class="form-control ans" id="out_supp_service_score" />
		            		<input type="text" class="form-control ans" id="info_sys_dev_score" />
		            	</div>
		            	<div class="col-md-1 col-sl-1 col-xs-1 ans">		            		
		            		<textarea class="big_big_qstn" id="it_env_score"></textarea>
		            	</div>
		            ...
		            <!----Impact of factors on audit time---------->
		            	...
		            	<div class="col-md-8 col-sl-8 col-xs-8 double">		          		            		
		            		<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="high_low">
			            	</div>
			            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="high_med">
			            	</div>
			            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="high_high">
			            	</div>

			            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="med_low">
			            	</div>
			            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="med_med">
			            	</div>
			            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="med_high">
			            	</div>

			            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="low_low">
			            	</div>
			            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="low_med">
			            	</div>
			            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
		            			<input class="form-control" type="text" id="low_high">
			            	</div>
		            	</div>
	            ...
	            <!------FSMS qsnts----------->
	            	...
	            	?>
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="td_man_days">
		            	</div>
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
		            		<input class="form-control" type="text" id="th_man_days">
		            	</div>
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="tms_man_days">
		            	</div>
		            	...
		            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
	            			<input class="form-control" type="text" id="tfte_man_days">
		            	</div>
		           <?php
	            		}
	            	?>
	        	...
	        	<!--------man days required------>
	            	...
	            	<div class="col-md-10 col-sl-10 col-xs-10 qstn">
	            		<div type="text" class="qstn_qstn ">Stage 1: Audit Man-days</div>
	            	</div>
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
            			<input class="form-control" type="number" id="stage1_man_days">
	            	</div>
	            	...
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
            			<input class="form-control" type="number" id="stage2_man_days">
	            	</div>
	            	...
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
            			<input class="form-control" type="number" id="surv1_man_days">
	            	</div>
	            	...
	            	<div class="col-md-2 col-sl-2 col-xs-2 ans">
            			<input class="form-control" type="number" id="surv2_man_days">
	            	</div>
	            ...
	            <!--------reasons to change time------>
	            	...
	            	<div class="col-md-12 col-sl-12 col-xs-12 ans">
            			<input class="form-control" type="text" id="oth_reas_inc_tym">
	            	</div>
	            	...
	            	<div class="col-md-12 col-sl-12 col-xs-12 ans">
            			<input class="form-control" type="text" id="oth_reas_desc_tym">
	            	</div>
	            	...
	            	<div class="col-md-9 col-sl-9 col-xs-9 ans">
            			<input class="form-control" type="text" id="tym_change_warning">
	            	</div>

	            <!---------audit 1 team planned----------->
	            	<div class="col-md-12 col-sl-12 col-xs-12"></div>
		            <div class="col-md-12 col-sl-12 col-xs-12"></div>
	            	
	            	<div class="col-md-12 col-sl-12 col-xs-12 qstn">
	            		<div type="text" class="qstn_qstn qstn_heading">Audit 1 Team Planned</div>
	            	</div>
	               		...
	               		<ul class="audit_auditor_ul" style="width: 80%; display: block; margin: auto; list-style: none;" >
	               			<li>	               				
			              		<div class="col-md-5 col-sl-5 col-xs-5 ans"> 
		                            <select class="form-control audit_auditor" level="1">
			                    ...
			                    <div class="col-md-5 col-sl-5 col-xs-5 ans"> 
		                            <select class="form-control audit_type" level="1">
	            ...
	            <!---------review and apporve--------->
	            	...
	            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
            			<input class="form-control" type="text" id="reviewed_by_name">
	            	</div>
	            	 <div class="col-md-2 col-sl-2 col-xs-2 qstn">
            			<div type="text" class="qstn_qstn qstn_heading">Approve By</div>
	            	</div>
	            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
            			<input class="form-control" type="text" id="apporved_by_name">
	            	</div>
	            	...
	            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
            			<input type="date" value="<?= date('Y-m-d'); ?>" id="reviewed_by_date">
	            	</div>
	            	 <div class="col-md-2 col-sl-2 col-xs-2 qstn">
            			<div type="text" class="qstn_qstn qstn_heading">Date</div>
	            	</div>
	            	<div class="col-md-4 col-sl-4 col-xs-4 ans">
            			<input type="date" value="<?= date('Y-m-d'); ?>" id="apporved_by_date">
	            	</div>  	
	            </div>
	            ...
	            <div class="text-center" >	      
	            	...
	            	<input type="hidden" id="app_rev_form_id" value="">
	          		<input type="submit" class="btn btn-primary text-center" id="app_review_submit_button" name="">
	          		<br><br>
	            </div>
	        </div>
	    </div>
	...
	//function to suggest anzsic code	
		...
		{			
			...
			if(anzsic_sugg_input != "")
			{
				...
				{
					var to_get = ['anzsic_code', 'group_name', 'code_description', 'risk', 'link'];
					...
					$.post('<?=base_url()?>technical/get_anzsic_sugg', {scheme_system:scheme_system, anzsic_sugg_input:anzsic_sugg_input, to_get:to_get}, function(data)
					{
						...
						$('.anzsic_sug_val').click(function()
						{
							...
							this_input.parent().parent().find('#anzsic_sugg_link').attr('href', link);
						...
						//inserting the site review dates into database	
							...
							//inserting the audtor team records in the app_rev audit_tem_plan table	
								...
								{		
									if(a == 1)
									{
										location.href= "<?=base_url()?>technical/view_application_review_form/" + tracksheet_id;	
									}
									else
									{

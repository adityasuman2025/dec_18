...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('customer/list_audit_plans'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
						...
						<tr>
							...
							<td>
								<?php
									...
									{
								?>
										<a class="btn btn-primary" href="<?php echo base_url('customer/view_my_re_audit_plan/'. $data_id); ?>">View</a>
								<?php			
									}
									else
									{
								?>
										<a class="btn btn-primary" href="<?php echo base_url('customer/view_my_audit_plan/'. $data_id . '/' . $level); ?>">View</a>
								<?php		
									}
								?>								
							</td>

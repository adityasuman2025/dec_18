...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('customer/fill_intimation_of_changes'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
        ...
        <div class="table-responsive db_common_tb">
	        ...
	        <thead>
	           <tr>
	       	 ...
	       	 <tbody>
				<?php
				//getting all the tracksheets for which feedback has been filled
					$tracksheet_ids = [];

					foreach ($list_filled_inti_filled_tracksheets as $key => $list_filled_inti_filled_tracksheet)
					{
						$tracksheet_id = $list_filled_inti_filled_tracksheet['tracksheet_id'];
						...
						<tr>
							...
							<td>
								<?php
									...
									{
								?>
									<form method="post" action="<?php echo base_url('customer/view_intimation_of_changes_form'); ?>">
								...
								<?php
									...
									{
								?>
										<form method="post" action="<?php echo base_url('customer/fill_intimation_of_changes_form'); ?>">
										<input type="hidden" name="tracksheet_id" value="<?php echo $data_id; ?>">
										<input type="hidden" name="level" value="<?php echo $level; ?>">

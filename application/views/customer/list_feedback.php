...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('customer/list_feedback'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	        ...
	        <thead>
	           <tr>
				...
				//getting all the tracksheets for which feedback has been filled
					...
					foreach ($list_filled_feedback_tracksheets as $key => $list_filled_feedback_tracksheet)
					{
						$tracksheet_id = $list_filled_feedback_tracksheet['tracksheet_id'];
						...
						<tr>
							...
							<td>
								<?php
									...
									{
								?>
										<a class="btn btn-primary" href="<?php echo base_url('customer/view_feedback/'. $data_id . '/2'); ?>">View</a>		
								<?php
									}
									else
									{
								?>
										<a class="btn btn-primary" href="<?php echo base_url('customer/fill_feedback/'. $data_id . '/2'); ?>">Fill</a>		
								<?php
									}
								?>											
							</td>

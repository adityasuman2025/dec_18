        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
	            ...
	            <!--more changes---->
	            	...
	            	<div class="col-md-8 col-sl-8 col-xs-8 ans">
	            		<textarea class="form-control" type="text" id="new_scope" ></textarea>
	            	</div>
...
<!----style and script-------->
	...
	//on clicking on submit button
		...
		//inserting the site address in database
			...
			$.post('<?php echo base_url('planning_actions/insert_inti_of_changes_records'); ?>', {tracksheet_id:tracksheet_id, level:level, new_client_name:new_client_name, new_contact_address:new_contact_address, no_of_emp:no_of_emp, perma_emp:perma_emp, temp_sites:temp_sites, new_scope:new_scope, any_process_change:any_process_change, remarks:remarks}, function(a)
			{
				var intimation_of_changes_id = a;

				$.post('<?php echo base_url('planning_actions/insert_inti_of_changes_site_records'); ?>', {intimation_of_changes_id:intimation_of_changes_id, site_address_records:site_address_records}, function(b)
				{
					if(b == 1)
					{
						location.href = "<?php echo base_url('planning/edit_tracksheet/' . $tracksheet_id); ?>";
					}
					else
					{

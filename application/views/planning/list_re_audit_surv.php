...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('planning/list_re_audit_surv'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
						...
						<tr>
							...
							<td>
								<?php 
									...
									{
										$href = base_url('planning_actions/notify_to_technical_about_re_audit/'. $id . '/' . $level);

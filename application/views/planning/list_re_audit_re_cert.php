...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('planning/list_re_audit_re_cert'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				?>
						...
						<tr>
							...
							<td>
								<?php 
									$notify_to_technical = $resval->notify_to_technical;

									if($notify_to_technical != 2)
									{
										$redirect_level = 2;

										$href = base_url('planning_actions/notify_to_technical_about_re_audit/'. $id . '/' . $level . '/' . $redirect_level);

										echo "<a class=\"btn btn-primary\" href=\"$href\">Notify</a>";
									}
									else
									{
										echo "Notified";
							...
							<td>																				
								<a class="btn btn-primary" href="<?php echo base_url('planning/view_audit_report_summary/'.$data_id . '/' . $level); ?>">View</a>
							</td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			

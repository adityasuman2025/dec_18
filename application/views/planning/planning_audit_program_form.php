	            ...
	            <div class="box-body">
		            ...
		            <div class="col-md-6 col-sl-12 col-xs-12">
		                <ul class="nav nav-stacked">
		                    ...
		                    <li><a href="#">No. of sites<span class="pull-right  ">3</span></a></li>
		              </ul>
		            </div>	
	            </div>           
            </div>
...
<!--------Stage 1-------->
	<section class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                      <h3 class="box-title">Stage 1 Audit</h3>
                ...
                <div class="box-body">
                    <div class="col-md-12 col-sl-12 col-xs-12">
                    	<ul class="nav nav-stacked">
                    		<li><a href="#">Man Days<span class="pull-right  "><?php echo $app_rev_form_record->stage1_man_days; ?> days</span></a></li>
                    		
                    		<li>
                    			<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date From
	                    			<input type="date" style="width: 100%; height: 34px;" id="1_date_from">
	                    		</div>
	                    		<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date To
	                    			<input type="date" style="width: 100%; height: 34px;" id="1_date_to">
	                    		</div>
                    		</li>
                    		...
                    		<div class="col-md-12 col-sl-12 col-xs-12 nav nav-stacked">
								...
								<?php									
			               		...
			               		<ul id="stage1_more_tech_exp" class="nav nav-stacked col-md-6 col-sl-6 col-xs-6">
			               			<li>
			               				<select style="width: 100%; height: 34px;" level="1" class="audit_auditor" type="2" sector="1">
			            ...
			            <!----secondary auditors------->   		
			               	<div class="col-md-12 col-sl-12 col-xs-12 nav nav-stacked">
								...
								<ul id="stage1_more_tech_exp" class="nav nav-stacked col-md-6 col-sl-6 col-xs-6">
			               			<li>
			               				<select style="width: 100%; height: 34px;" level="1" class="audit_auditor" type="1" sector="2">
			            ...
			            <!--------choice of auditor sector-------->
			            	...
			            	<select style="width: 50%; height: 34px;" id="stage1_auditor_sector">
                    ...
                    <div class="col-md-12 col-sl-12 col-xs-12">
                    	<ul class="nav nav-stacked">
                    		...
                    		<li>
                    			<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date From
	                    			<input type="date" style="width: 100%; height: 34px;" id="2_date_from">
	                    		</div>
	                    		<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date To
	                    			<input type="date" style="width: 100%; height: 34px;" id="2_date_to">
	                    		</div>
                    		</li>
                    ...
                    <div class="col-md-12 col-sl-12 col-xs-12">
                    	<ul class="nav nav-stacked">
                    		...
                    		<li>
                    			<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date From
	                    			<input type="date" style="width: 100%; height: 34px;" id="3_date_from">
	                    		</div>
	                    		<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date To
	                    			<input type="date" style="width: 100%; height: 34px;" id="3_date_to">
	                    		</div>
                    		</li>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                    ...
                    <div class="col-md-12 col-sl-12 col-xs-12">
                    	<ul class="nav nav-stacked">
                    		...
                    		<li>
                    			<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date From
	                    			<input type="date" style="width: 100%; height: 34px;" id="4_date_from">
	                    		</div>
	                    		<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date To
	                    			<input type="date" style="width: 100%; height: 34px;" id="4_date_to">
	                    		</div>
                    		</li>
                ...
                <div class="col-sl-12 col-md-12 col-xs-12 text-center">
                	<br><br>
                	<button class="btn btn-primary" id="submit_form_button">Submit</button>    
                </div>
...
//on clicking on submit buttonm
	$('#submit_form_button').click(function()
	{
		...
		var cm_id = "<?php echo $database_record->cm_id; ?>";
	...
	//entering data into audit program form table
		$.post('<?php echo base_url('planning_actions/insert_data_in_audit_program_form_planning'); ?>', {tracksheet_id: tracksheet_id, cm_id:cm_id, no_of_sites:no_of_sites, stage1_auditor_sector:stage1_auditor_sector, stage2_auditor_sector:stage2_auditor_sector, surv1_auditor_sector:surv1_auditor_sector, surv2_auditor_sector:surv2_auditor_sector ,stage1_date_from:stage1_date_from, stage1_date_to:stage1_date_to, stage2_date_from:stage2_date_from, stage2_date_to:stage2_date_to, surv1_date_from:surv1_date_from, surv1_date_to:surv1_date_to, surv2_date_from:surv2_date_from, surv2_date_to:surv2_date_to}, function(data)
		{		
		...
		//redirecting to the audit program page
			...
			{
				location.href="<?php echo base_url('planning/fill_audit_program'); ?>";
			}, 1500);
		});	
	});
</script>
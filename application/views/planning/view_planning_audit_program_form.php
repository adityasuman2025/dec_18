                    ...
                    <div class="col-md-12 col-sl-12 col-xs-12">
                    	<ul class="nav nav-stacked">
                    		...
                    		<li>
                    			<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date From
	                    			<input type="date" style="width: 100%; height: 34px;" id="1_date_from" value="<?php echo $stage1_date_from; ?>">
	                    		</div>
	                    		<div class="col-md-6 col-sl-6 col-xs-6">
	                    			Date To
	                    			<input type="date" style="width: 100%; height: 34px;" id="1_date_to" value="<?php echo $stage1_date_to; ?>">
	                    		</div>
                    		</li>
			            ...
			            <!--------choice of auditor sector-------->
			            	...
			            	<select style="width: 50%; height: 34px;" id="stage1_auditor_sector">
			            		<?php
			            			sector_list($stage1_auditor_sector);
			            		?>
			            	</select>
                    	</ul>
                    </div>

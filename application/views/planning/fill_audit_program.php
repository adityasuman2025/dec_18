							...
							<td>			
								<?php				
									if($date_filled_status == "NO")
									{
										...
										echo " <a class=\"btn btn-primary\" href=\"" . base_url('planning/planning_audit_program_form/'. $data_id) . "\">Fill</a>";
									}	
									else
									{
										echo $date_filled_status;
										echo " <a class=\"btn btn-primary\" href=\"" . base_url('planning/view_planning_audit_program_form/'. $data_id) . "\">View</a>";
									}																		
								?>
							</td>
							<td>																				
								<?php				
									...
									{
										echo $intimation_status;
										echo " <a class=\"btn btn-primary\" href=\"" . base_url('planning/send_intim/1/'. $data_id) . "\">Send1</a>";
									}	
									else if($intimation_status = "Sent1")
									{
										echo "Sent For Stage 1";
									}																	
								?>
							</td>
						</tr>

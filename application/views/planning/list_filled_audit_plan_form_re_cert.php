...
<div class="db_filter">
	<div class="db_filter_mc">
        ...
        <div class="db_filter_cont">
	        <?php echo form_open(base_url('planning/list_filled_audit_plan_form_re_cert'),['id' => 'searchForm','class' => 'nor_form', 'name' => 'searchForm', 'method' => 'post'])?>
	         <div class="form_comp">
	           ...
	           <tr>
				...
				<?php
					...
					if($result_array)
					{
						...
						{	
							...
							$query = "SELECT ldt_audit_program_form.intimation_status FROM ldt_audit_program_form WHERE ldt_audit_program_form.tracksheet_id = $data_id";
				...
				?>
						...
						<tr>
							...
							<td>
								<?php 
									...
									else
									{
										...
										echo "<a class=\"btn btn-primary\" href=\"" . base_url('planning_actions/notify_client_about_audit_plan/' . $level . "/" . $tracksheet_id . "/" . $cm_id . '/' . $redirect_level) . "\">Send</a>";
									}
								?>								
							</td>
							<td>
								<?php 
									...
									else
									{
										...
										echo "<a class=\"btn btn-primary\" href=\"" . base_url('planning_actions/notify_auditors_about_audit_plan/' . $level . "/" . $tracksheet_id . '/' . $redirect_level) . "\">Send</a>";
									}
								?>								
							</td>
							<td>																				
								<?php				
									...
									else if($intimation_status_result == 2 && $cert_type == 4)
									{
							...
							<td>																				
								<a class="btn btn-primary" href="<?php echo base_url('planning/view_audit_plan_form_re_cert/'.$data_id); ?>">View</a>
							</td>
						</tr>
				<?php	
							$SlNo							=	$SlNo+1;			
